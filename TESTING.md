...
| 15 | ~~เหตุผลการตีกลับไม่แสดงในเมล~~ **ไม่ใช่บัค — เป็นความตั้งใจ** | — | เดิมรายงานว่า `note` ถูกส่งเข้าเมลแต่ไม่ถูก render — เจ้าของระบบยืนยันว่าตั้งใจ: **เมลมีหน้าที่แจ้งเหตุการณ์เท่านั้น รายละเอียดดูในระบบ** จึงคงพฤติกรรมเดิมไว้ และมีเทสต์ล็อกไว้ว่า note ต้องไม่โผล่ในเมล |
...
| H7 | admin ตีกลับหลักสูตรพร้อม note | เมลแจ้ง "ส่งกลับแก้ไข" ตามปกติ **โดยไม่แสดง note** (ตั้งใจ — ดูรายละเอียดในระบบ), note เห็นครบในหน้ารายละเอียด/ประวัติ |
